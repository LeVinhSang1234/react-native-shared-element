...
import com.reactnativesharedelement.view.RCTShareView
 ...
 */
object RCTShareViewTag {
    private val tagToViewsMap =
        ConcurrentHashMap<String, MutableList<WeakReference<RCTShareView>>>()

    @JvmStatic
    fun registerView(view: RCTShareView?, tag: String?) {
    ...
    @JvmStatic
    fun removeView(view: RCTShareView?, tag: String?) {
    ...
    @JvmStatic
    fun getOtherViewForTag(view: RCTShareView?, tag: String?): RCTShareView? {
